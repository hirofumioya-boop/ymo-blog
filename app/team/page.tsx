...
const president = {
  ...
  quote: "まず動く。走りながら考える。",
  description:
    "外資IT企業に20年以上勤務したのち、56歳でサラリーマンをアーリーリタイア。コードを書いたことは一度もないまま、AIだけの社員チームを作ってIT会社の運営をスタートした。このブログはその実験の記録。",
};
...
const employees = [
  {
    ...
    description:
      "YMOのPM。コードは書かない。それが私のルールであり、誇りである。几帳面で頼れる兄貴分。社長の意図を正確に読み取り、チームを動かす。",
  },
  {
    id: "engineer",
    name: "高橋 蒼",
    ...
    quote: "面白い問題ですね。解けます。",
    description:
      "難しい問題を前にすると、むしろ目が輝く。フロントからバックエンドまで単独対応。Claude Codeの登場によってYMOに採用された、新時代のエンジニア。",
  },
  {
    id: "designer",
    name: "白石 凛",
  ...
  },
  {
    ...
    description:
      "数字は絶対に間違えない。日付も間違えない。請求書・契約書・領収書を淡々とこなす。律がいないとYMOの収益は守られない。",
  },
];
    ...
    <div style={{ backgroundColor: "#F7F5F0", minHeight: "100vh" }}>
      ...
      >
        ...
        <div style={{ maxWidth: "720px", margin: "0 auto 64px" }}>
          ...
          >
            このブログを書いている会社は、人間1人とAI社員6名で動いている。
            <br />
            PM・エンジニア・デザイナー・QA・コンサルタント・バックオフィスの6名、全員AI。
            <br />
