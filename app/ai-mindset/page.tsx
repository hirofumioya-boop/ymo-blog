...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://blog.y-m-o.jp/ai-mindset',
  },
  openGraph: {
...
④ 仮説を持って問いかける
「〇〇だと思っているが、どうか」という形で問う。仮説があると、AIの答えが格段に使いやすくなります。

これは、優秀なコンサルタントへのブリーフィングと変わりません。`,
  },
  {
    number: "原則2",
    title: "戦略と判断はあなたの仕事。AIは実行を支える",
    body: `AIはあなたの判断を代わりに下しません。あなたが「こっちだ」と決めるための材料と問いを提供します。
...
AIの最大の価値は、答えを出すことではなく、あなたが自分で答えに辿り着けるよう問いを立てることです。「なぜ?」「本当にそうか?」「別の角度から見ると?」——そういう問いを引き出せたとき、AIが機能しています。`,
  },
  {
    ...
    body: `AIは、あなたの文脈を知るほど精度が上がります。課題の表面だけでなく、背景を伝えてください。
...
「忙しいから手短に」と結論だけを求めると、結論も手短なものになります。背景を渡すことが、深い助言への近道です。`,
  ...
  {
    number: "原則5",
    title: "あなたの経験が、AIを賢くする",
    body: `AIの質は、あなたのインプットの質で決まります。

業界の知識、顧客との長年の関係、これまでの経営判断の積み重ね——これがAIへのインプットの質を決め、アウトプットの質も決めます。「AIは専門家にしか使えない」は誤解です。あなたの経験と判断軸こそが、AIを賢くする燃料です。`,
  },
  {
    number: "原則6",
    title: "AIの評価を、使いながら更新する",
    body: `最初は「こんなものか」と感じるかもしれません。しかし使い続けるほど、AIはあなたを理解していきます。

また、AIそのものの進化も速い。1ヶ月前にできなかったことが今日できることも多い。「前に試してうまくいかなかった」という経験は、定期的に更新してください。`,
  },
  {
    number: "原則7",
    title: "AIを過信せず、道具として過小評価もしない",
    body: `AIを万能と思うと、ハルシネーションに気づかなくなります。逆に「どうせAIだから」と舐めてかかると、引き出せる価値が大幅に下がります。
...
const aiNature = [
  {
    ...
    body: `これを[[ハルシネーション|/glossary#hallucination]]と呼びます。
...
返ってくる答えは、あなたが渡したコンテキストの鏡です。品質が安定しないと感じたら、まず自分の問いかけ方を振り返ってみてください。`,
  },
  {
    label: "事実D",
    title: "セキュリティを意識して使う",
    body: `AIとの対話の内容は、AI応答の生成に使用されます。機密性の高い情報の取り扱いは、以下を意識してください。
