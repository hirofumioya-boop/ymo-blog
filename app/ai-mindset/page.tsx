...
適切な距離感は、「優秀だが経験の浅いコンサルタント」です。分析力と知識は高いが、あなたの業界・顧客・組織の固有事情は知らない。その前提で問いかけ、返ってきた答えを自分の文脈で判断する。`,
  },
  {
    number: "原則8",
    ...
    <div style={{ backgroundColor: "#F7F5F0", minHeight: "100vh" }}>
      ...
      >
        ...
        <div style={{ marginBottom: "48px" }}>
          ...
          >
            参謀が最も力を発揮するのは、あなたが「本当に考えたいこと」を正直に持ち込んだときです。整理されていなくても構いません。「実は……」から始まる話に、一番深い答えが生まれます。
          </p>
        </div>
