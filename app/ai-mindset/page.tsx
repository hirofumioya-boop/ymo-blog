...
const principles = [
  {
    number: "原則1",
    title: "部下への指示と同じ4つの法則で、AI参謀を動かす",
...
④ 仮説を持って問いかける
「〇〇だと思っているが、どうか」という形で問う。仮説があると、AI参謀の答えが格段に使いやすくなります。

これは、優秀なコンサルタントへのブリーフィングと変わりません。`,
  },
  {
    number: "原則2",
    title: "戦略と判断はあなたの仕事。AI参謀は実行を支える",
    body: `AI参謀はあなたの判断を代わりに下しません。あなたが「こっちだ」と決めるための材料と問いを提供します。

あなたの役割は、方向付け・最終判断・決めたことを実行に移すこと。AI参謀の役割は、情報整理・選択肢の提示・壁打ち・叩き台作成です。最後に決めるのは、常にあなたです。`,
  },
  {
    number: "原則3",
...
AI参謀の最大の価値は、答えを出すことではなく、あなたが自分で答えに辿り着けるよう問いを立てることです。「なぜ?」「本当にそうか?」「別の角度から見ると?」——そういう問いを引き出せたとき、AI参謀が機能しています。`,
  },
  {
    number: "原則4",
    title: "背景を渡すほど、助言が深くなる",
    body: `AI参謀は、あなたの文脈を知るほど精度が上がります。課題の表面だけでなく、背景を伝えてください。
...
「忙しいから手短に」と結論だけを求めると、結論も手短なものになります。背景を渡すことが、深い助言への近道です。`,
  ...
  {
    number: "原則5",
    title: "あなたの経験が、AI参謀を賢くする",
    body: `AI参謀の質は、あなたのインプットの質で決まります。

業界の知識、顧客との長年の関係、これまでの経営判断の積み重ね——これがAI参謀へのインプットの質を決めます。「AIは専門家にしか使えない」は誤解です。あなたの経験と判断軸こそが、AI参謀を賢くする燃料です。`,
  },
  {
    number: "原則6",
    title: "AI参謀の評価を、使いながら更新する",
    body: `最初は「こんなものか」と感じるかもしれません。しかし使い続けるほど、AI参謀はあなたを理解していきます。

また、AIそのものの進化も速い。1ヶ月前にできなかったことが今日できることも多い。「前に試してうまくいかなかった」という経験は、定期的に更新してください。`,
  },
  {
    number: "原則7",
    title: "AI参謀を過信せず、道具として過小評価もしない",
...
でも、AI参謀はあなたの感情に反応しません。焦っても、怒っても、状況は変わりません。むしろ感情的な状態では良い問いが作れず、アウトプットの質がさらに下がります。

うまくいかないと感じたら、一度立ち止まる。「何を伝えようとしているのか」を整理し直す。冷静に問いを組み立て直すだけで、まったく違う結果が出ることがあります。AI参謀は感情を持ちません。だからこそ、あなたが冷静でいることが、最も効率的な使い方です。`,
  },
];
    ...
    <div style={{ backgroundColor: "#F7F5F0", minHeight: "100vh" }}>
      ...
      >
        ...
        <div style={{ marginBottom: "56px" }}>
          ...
          >
            汎用AIも、最近は記憶機能を持つものが増えてきました。ただ、その記憶は「あなたが話したこと」を引き継ぐもの。あなたの事業の文脈や、経営判断の背景、大切にしている価値観を深く理解した上で動いているわけではありません。
          </p>
          <p
            style={{
              fontFamily: '"Noto Sans JP", "ヒラギノ角ゴ Pro", sans-serif',
          ...
          >
            ただし、そのためには条件があります。あなたが何を渡すかで、AI参謀の質が決まる。
          </p>
        </div>
        ...
        <div style={{ marginBottom: "48px" }}>
          ...
          >
            AI参謀が最も力を発揮するのは、あなたが「本当に考えたいこと」を正直に持ち込んだときです。建前ではなく、本音の課題を。整理されていなくても構いません。「実は……」から始まる話に、一番深い答えが生まれます。
          </p>
        </div>
