...
const terms = [
  ...
  },
  {
    ...
    description:
      "意思決定を構造化するフレームワーク。Driver（推進者）・Approver（承認者）・Contributor（情報提供者）・Informed（共有対象）の4役割を明示することで、「誰が決めるのか」「誰に相談するのか」をはっきりさせる。会議が止まる原因の多くは、この役割が曖昧なことにある。このブログNo.40では、AI参謀がフレームワークの存在をあらかじめ宣言してから使う「ワンブリーフィング型」の例として登場する。",
  },
  {
    term: "Day 1",
    reading: "デイワン",
