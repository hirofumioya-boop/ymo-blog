...
const terms = [
  ...
  },
  {
    ...
    description:
      "テキストの「意味」を数値の列（ベクトル）に変換する技術のこと。たとえば「源泉徴収」「天引き」「税額控除」は言葉は違っても意味が近い。この近さを数値の距離として表現することで、キーワードがぴったり一致しなくても、意味的に関連する情報を探し出せるようになる。我が社の税務相談AIでは、この技術を意味検索の仕組み（RAG）に組み込んでいる。相談者が専門用語を知らなくても正確な法令に辿り着けるのは、表現の揺れをここで吸収しているからだ。",
  },
  {
    id: "winget",
    term: "WinGet",
