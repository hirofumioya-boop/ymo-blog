...
const terms = [
  ...
  },
  {
    ...
    reading: "テスト（Test）",
    description:
      "ソフトウェアや仕組みが正しく動くかどうかを確認する作業のこと。バグ（不具合）がないか、意図した通りに動作するかを多角的に検証する。テストなしのリリースは「動いていると信じているだけ」にすぎない。このブログのAIチームではQAの黒川さんが全リリース前のテストを担当しており、「リリースしていいと言えるのは、私がOKを出したときだけ」というスタンスで品質を守っている。",
  },
  {
    term: "EQ",
