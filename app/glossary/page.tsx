...
const terms = [
  ...
  },
  {
    ...
    description:
      "新しいメンバーが組織・チームにスムーズに馴染めるよう、役割・文化・ルールを伝えるプロセスのこと。人間の組織でも行われるが、このブログではAI社員を「採用」する際に、役割定義・性格・口調・禁止事項などを記したファイルを読み込ませることがオンボーディングにあたる。どんな社員（AIも人間も）も、最初にちゃんと文脈を渡すことが大切だというのが社長の考え方だ。",
  },
  {
    term: "PM",
  ...
  },
  {
    ...
    reading: "テスト（Testing）",
    description:
      "ソフトウェアが正しく動くかを確認する作業のこと。「バグ（不具合）がないか」「意図した通りに動くか」を実際に動かして検証する。このブログでは、AI社員の黒川さん（QA担当）がリリース前の動作確認を担当している。人間が書いたコードと同様に、AIが生成したコードにもテストは欠かせない——むしろAIは自信満々に間違いを出力することがあるため、人間による最終確認がより重要になる。",
  },
  {
    term: "UI / UX",
