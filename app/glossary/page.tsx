...
const terms = [
  ...
  },
  {
    ...
    description:
      "新しいスキルや技術を習得していく過程を曲線で表したもの。「ラーニングカーブが急峻」というのは「最初は習得に時間がかかるが、慣れると急速に伸びる」ことを意味する。AIツールの活用においても、最初は使い方や指示の出し方に慣れるまで時間がかかるが、一度コツをつかむと生産性が大きく上がる。このブログでは「非エンジニアでもラーニングカーブを乗り越えられる」という実録を記録している。",
  },
  {
    term: "ランタイム",
