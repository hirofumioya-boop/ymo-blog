...
const terms = [
  ...
  {
    term: "マトリックス（The Matrix）",
    reading: "マトリックス",
    description:
      "1999年公開のSF映画。ウォシャウスキー姉妹監督作品。人類がAIに支配されており、現実だと思っている世界は実はコンピューターが作り出したシミュレーションだった——という世界観。このブログのNo.22では、主人公トリニティがヘリコプターの操縦マニュアルを瞬時にダウンロードして読み込むシーンが、AIの情報処理の仕組みと重なるという話が登場する。",
  },
  {
    term: "Markdown / .md",
    reading: "マークダウン",
