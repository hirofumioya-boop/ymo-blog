    ...
    <div style={{ backgroundColor: "#F7F5F0", minHeight: "100vh" }}>
      ...
      >
        ...
        <div className="article-body">
          ...
          <p>
            AIだけの社員チームで会社を動かした実録を、経営者の視点から書いています。技術の解説ではなく、「非エンジニアがAIとどう向き合ったか」の記録です。
          </p>

          <p>
            エンジニアなら効率化ツールとしてAIを使いこなすでしょう。私のアプローチは違います。17年間、人の組織を動かしてきた経験——採用、役割定義、権限委譲、反論を歓迎する文化づくり——をそのままAIに持ち込みました。それが私にできる、唯一のアプローチでした。
          </p>
          ...
          <p>
            ...
            「人を動かす力とAIを動かす力は、思ったより同じものだった」というのが、今のところの結論です。
          </p>
