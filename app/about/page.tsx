    ...
    <div style={{ backgroundColor: "#F7F5F0", minHeight: "100vh" }}>
      ...
      >
        ...
        <div className="article-body">
          ...
          <p>
            外資IT企業2社に計22年勤務したのち、56歳でサラリーマンをアーリーリタイアしました。うち17年間はマネージメント職に従事（Adobe 10年・Amazon 7年）。特にAmazonでは、クラウドビジネスに携わる傍ら、採用・育成・評価・組織運営の実務を担い、面接官として関わった候補者は延べ約700名にのぼります。
