    ...
    <div style={{ backgroundColor: "#F7F5F0", minHeight: "100vh" }}>
      ...
      >
        ...
        <div className="article-body">
          ...
          <p>
            「人を動かすということと、AIを動かすということは、本質的には同じではないか」——Amazonで7年間培った組織設計/運営の経験が、AIチームの設計/運営でも同じように機能しそうだと感じ始めています。どちらも、「仕組み」と「言葉（言語化）」が鍵になると思います。私が提供できるのは、人材採用・育成と組織運営、そしてAI導入、その両面からの支援です。
          </p>
