    ...
    <div style={{ backgroundColor: "#F7F5F0", minHeight: "100vh" }}>
      ...
      >
        ...
        <div className="article-body">
          <p>このブログは、AIに興味はあるがとっかかりがわからない、非エンジニアの経営者のために書いています。</p>
          <p>やってみてわかったことがあります。AIは技術の話ではありませんでした。経営者なら誰でも知っている、組織論の話でした。</p>
          <p>Adobe・Amazon合計22年、17年間のマネジメント経験を持つ筆者が、コードを一行も書かずにAIチームを立ち上げた実録です。試行錯誤の過程をすべて記録しています。</p>

          <h2>このブログについて</h2>

          <p>
            AIだけの社員チームで会社を立ち上げた実録を、経営者の視点から書いています。技術の解説ではなく、「非エンジニアがAIとどう向き合ってきたか」の記録です。
          </p>
