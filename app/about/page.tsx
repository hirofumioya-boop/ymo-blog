    ...
    <div style={{ backgroundColor: "#F7F5F0", minHeight: "100vh" }}>
      ...
      >
        ...
        <div className="article-body">
          ...
          <p>
            AIだけの社員チームで会社を立ち上げた実録を、経営者の視点から書いています。技術の解説ではなく、「非エンジニアがAIとどう向き合うか」の記録です。
          </p>

          <p>
            エンジニアなら効率化ツールとしてAIを使いこなすでしょう。しかし、私のアプローチは異なります。外資2社で17年間、人の組織を動かしてきた経験——採用、役割定義、権限委譲、反論を歓迎する文化づくり——それらをそのままAIに持ち込みました。それが私にできる、唯一のアプローチでした。
          </p>
          ...
          <p>
            外資IT企業2社に計22年勤務したのち、56歳でサラリーマンをアーリーリタイアしました（Adobe 15年・Amazon 7年）。うち17年間はマネージメント職に従事（Adobe勤務中の10年・Amazon在籍の7年全期間）。特にAmazonでは、クラウドビジネスに携わる傍ら、採用・育成・評価・組織運営の実務を担い、面接官として関わった候補者は延べ約700名にのぼります。
          ...
          <p>
            「人を動かすということと、AIを動かすということは、本質的には同じではないか」——Amazonで7年間培った組織設計/運営の経験が、AIチームの設計/運営でも同じように機能しそうだと感じ始めています。どちらも、「仕組み」と「言葉（言語化）」が鍵になると思います。私が提供できるのは、人材採用・育成と組織運営、そして経営者目線でのAI導入、その両面からの支援です。
          </p>

          <h3>採用・組織運営コンサルティング</h3>
          <p>
            採れない、育たない、辞める——その原因の多くは、採用・育成の仕組みと、企業カルチャーの浸透不足にあると考えています。
            Amazonで培った採用・評価・育成の"仕組み化"をベースに、組織の根本課題に向き合います。
            採用基準の標準化〜面接官育成〜企業カルチャー醸成を一貫して支援します。AIも積極的に活用しながら進めます。
          </p>
