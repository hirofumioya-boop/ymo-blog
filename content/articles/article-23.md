...
<p>自動記憶は3日で50ドル超えた。判断軸の設計に切り替えた、コストが生んだ知恵。</p>
<p>自動記憶は3日で50ドル超え、頻度を落とすしかなかった。
全記録から重要記録の選別へ。判断軸の設計をチームに委ね、枠組みは人間が設計しAIが中で動く形にした。
コスト制約が、より賢い設計を導いた——Frugalityが体現された回。</p>
</aside>
...
その直後に思った——彼ら自身が、この議論の重要性を判断してくれるのではないか、と。もしそれが重要な議論だったとしたら、彼らの判断でそれが重要だと教えてくれるのではないか、と。
