...
実は今日の経緯はこうだ。外出中に時間ができたので、素のAI（チームとしてカスタマイズしていない、標準状態のAI）と分析手法についてブレストしていた。オフィスに戻ってから、そのブレストをもとに宮本さんと真田さんに「サービスに学習しよう」と持ちかけた。でも改めて気づいた——この二人（AI）も当然、同じことを全部知っている。外でAIと議論してきた内容を、別のAIに「学習しよう」と持ちかけていたわけだ。

笑えるオチだが、これは多くのAI導入現場でも起きているはずだ。AIは前に進めようとするのが得意だ。指示があれば、どんどん設計を積み上げる。でも「そもそも、これ必要ですか？」と立ち止まらせるのは、まだ人間の仕事だ。
では、今日の設計はゼロになったのか。
