...
<p>分析手法をAIに教えようとしたら、既に知っていた。渡すべきは知識ではなく文脈だった話。</p>
<p>SWOT・5Whys・DACIをAIに実装しようと半日かけたが、確認したら全部学習済みだった。
知識（IQ）は既に持っている。渡すべきはEQ的文脈——この人が何を大切にし、なぜそうなのか。
「なぜ大切か」まで伝えて初めて、AIは"その人の参謀"になれる。文脈を知っているから、腹を割れる。</p>
</aside>
...
[SWOT分析](/glossary#swot)、[5 Whys](/glossary#5-whys)、[DACI](/glossary#daci)（意思決定の構造化手法のひとつ）——これらの分析手法を、AIチームが経営者の問いに応じて使い分けられるよう設計しようという話だ。
