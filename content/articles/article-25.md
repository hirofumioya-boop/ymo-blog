...
これは経営学でいう**デレゲーション（権限移譲）**の本質だ。仕事を任せるとは、丸投げすることではない。**期待するアウトプットのイメージを、きちんと言語化して渡すこと**だ。
...
**AIへの丸投げは、なぜうまくいかないのか。** 答えはシンプルだ。任せる側の準備が足りないからだ。
