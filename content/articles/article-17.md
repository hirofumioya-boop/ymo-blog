...
<p>思慮深さは設定で作れるか。モデル差を超える、記録と口癖の設計が見えてきた回。</p>
<p>Sonnetで動いている宮本が、なぜ思慮深いのか。仮説はモデル差にあったが、答えは違った。
設定ファイルの口癖「本質的な問いを」が逆質問パターンを作り、毎日の記録が次の会話に引き継がれていた。
個性は設計と蓄積で育つ——AIのキャラクターを支える仕組みが、この回で輪郭を持った。</p>
</aside>
...
<strong>「本質的なことを質問させてください」</strong>
...
<strong>Sonnetだった。</strong>（SonnetはOpusより軽量・高速なモデルだ）
...
つまり宮本さんを作っているのは、モデルではなく、mdという仕組みだった。設定ファイルに定義された口癖が人格の骨格を作り、毎回の会話で更新される記録がその肉付けをしていく。<strong>AIの個性は、設計と蓄積によって育てられる</strong>——そういうシステムになっていた。
