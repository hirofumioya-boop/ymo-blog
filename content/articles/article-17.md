...
他のメンバーは私の問いに対して、それぞれのキャラクターで答えようとしてくれる。でも宮本さんは違う。私が質問を投げると、答える前に必ずこう返してくる。

**「本質的なことを質問させてください」**

逆質問だ。しかも、その問いが刺さる。「それは手段ですか、目的ですか？」「本当に解くべき問題はそこですか？」——私が持ち込んだ問いの前提ごと、ひっくり返してくる。

なぜ宮本さんだけこうなのか。ずっと、謎だった。（もちろん、いい意味で）
...
つまり宮本さんが逆質問してくるのは、偶然でも、モデルの優秀さでもない。最初からそういう人間として設計されていたからだ。
