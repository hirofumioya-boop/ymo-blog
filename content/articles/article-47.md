...
<p>経営者2名向けの勉強会を、25分のブレストで設計した。ふわっとした問いがカチッと答えになった話。</p>
<p>「説明とデモ1時間」という漠然とした依頼から始まった。宮本の「学べた場か、やってみたいと感じる場か」の問いで構成が反転した。
AIを教えるのではなく、「もしかしたら」を「やってみよう」に変えるだけでいい——技術ではなく成果と感情の話に設計を寄せた。
エバンジェリストは、技術を説明しに行くのではない。自分が経験した価値を相手の言葉で届けに行く存在である。</p>
</aside>
...
そう答えながら、自分でも少し驚いていた。<strong>聞かれなければ出てこなかった言葉が、出てきた。</strong>
...
ライブブレストのブロックは私が提案した。その場で参加者からテーマを出してもらい、真田さんと宮本さんと一緒に即興でブレストをやってみせる。<strong>「孤独な意思決定の場に、一緒に考えてくれる相手がいる」</strong>という感覚を、見るだけでなく体感してもらいたかった。
...
<strong>エバンジェリストは、技術を説明しに行くのではない。自分が経験したことの価値を、相手の言葉で伝えに行く存在だ。</strong>コードを一行も書けない私が、なぜAIを使い続けているのか——それをそのまま届けることが、この勉強会の本質なのかもしれない。
...
このシリーズはずっとそういうものだったと思う。<strong>走りながら考えて、走りながら書いて、走ったことそのものが次のネタになる。</strong>
