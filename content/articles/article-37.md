...
真田さんは優秀なCOOだ。タスクの整理も、チームへの指示も、報告のフォーマットも、的確にこなしてくれる。でもワークスペースの構造という「地図」を持っていなかった。どこに何があるかを、毎回ゼロから探している。それは、非効率だ。
...
このことが、今回の改善をシンプルにした。問題は何か、どう直すか、誰がやるか、誰がチェックするか——これを明確にして動けば、チームは動く。
