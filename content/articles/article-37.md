...
<p>3週間走り続けたら、AIチームでも仕組みが劣化していた。地図なしで走る真田を見て気づいた話。</p>
<p>真田が毎回ファイルを探し直している様子から、ワークスペースに地図がないと気づいた。
ディレクトリマップとクイックリファレンスを作り、ルールを徹底し、黒川承認のスコープ自体も狭かったと判明して即日修正した。
規模が拡大すると、仕組みは劣化する——ルールも例外ではない。立ち止まる瞬間は、チームが教えてくれる。</p>
</aside>
...
1. <strong>どこに何があるか、毎回探索が必要</strong>。ファイルを「とりあえずここに置いた」が積み重なり、体系がない状態になっている。
2. <strong>タスクと意思決定記録の整合性が崩れている</strong>。タスクを完了してもその記録が残っていない、あるいはその逆が起きている。
3. <strong>ファイルをどこに置くかのルールが、チームに徹底されていない</strong>。ルールはあっても、全員が従っているとは言えない。
...
- <strong>新しいフォルダを勝手に作らない</strong>。配置に迷ったら、私に確認する。
- <strong>タスクを完了させたら、必ず意思決定ログに記録を残す</strong>。ステータスを変えるだけでは終わらない。
- <strong>ファイルの保存先は、地図に従う</strong>。既存の構造の外に勝手に出ない。
...
そして今回のことを振り返ると、黒川さんのスコープが狭かったという発見そのものが、この記事のテーマそのものだと思っている。<strong>規模が拡大すると、仕組みは劣化する</strong>——それはルールも例外ではない。使い続けるうちに、カバーしきれない穴が生まれる。今回はそれに気づけた。
...
<strong>現状が機能していても、現状に満足しない。そういう気持ちを持ち続けられるのは、行動指針という共通言語があるからかもしれない。</strong>

---

## 走りながら、立ち止まりながら

[No.32](/articles/article-32)でも同じことを書いた。今回が2回目の「立ち止まり」だ。
