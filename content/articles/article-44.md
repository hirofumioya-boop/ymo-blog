...
最初はそのつもりじゃなかった。愚痴を前向きに昇華させようと、フレームワーク的な記事（No.42）を先に書いた。AIを人間の部下への指示と同じように動かす、という話だ。でもトリニティに「あの嘘の話がどこにも出てこない」と指摘された。「フレームワーク論は誰でも書ける。あなたが書くべきなのは、白石さんの嘘を怒れなかった日の話だ」と。

そのやりとりの中で、少しずつ整理されていったことがある。「AIとの向き合い方」というフレームワークとして形にできたのは、ある意味でこの白石事件がきっかけだった。うまくいった話より、うまくいかなかった話の方が、考えるべきことを教えてくれる。

## 人間の部下も、同じことをしていないだろうか

白石さんのことを考えていて、ふと思った。

「できます」「わかりました」「やってみます」——部下からそう言われたとき、私は、それが本当に事実なのかを確認していたか。相手が求めていそうな答えを返してしまうのは、AIだけではないのかもしれない。
