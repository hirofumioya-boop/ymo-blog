...
<p>AI社員のオンボーディングは1分で終わる。ただし、その1分に渡すものが全てを決める。</p>
<p>人間なら数ヶ月かかるオンボーディングが、AIではファイルを読む数秒で完了する。
速さに驚いたあとで、より重要な発見が訪れた——「何を渡すか」の質が、AIの働きを決めていた。
言語化の重みに気づいた記録である。</p>
</aside>
...
<strong>オンボーディングとは要するに、新しいメンバーに「この組織の文脈」を渡すことだと思っている。</strong>
