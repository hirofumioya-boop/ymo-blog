...
date: "2026-03-26"
tags: ["チームの作り方", "失敗談"]
excerpt: "事業計画書をAIチームが4時間で完成させた。社長がやったのは話すことと承認だけ。責任共有モデルという視点が、信頼の土台になることが見えた回。"
summary-type: "整理型"
...
<p>AIに任せられる範囲と、人間が引き受ける責任。その境界線を提案書一本で描き切った日の記録。</p>
<p>事業計画書をAIチームが4時間で完成させた。社長がやったのは話すことと承認だけ。
クラウドの責任共有モデルをAIに応用した「守備範囲の明確化」が、信頼の土台になることが見えた。
AIは自信満々に間違える——それを人間が最後に確認する設計まで含めて整理した回。</p>
</aside>
...
初回（[No.1](/articles/article-01)）の記事で、「AIに社員を演じさせたら、本当に仕事をしてくれた」という話を書いた。
