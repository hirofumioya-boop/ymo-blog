...
そのとき、AWSが提唱したのが「**責任共有モデル**」という考え方だった。クラウドのインフラはAWSが責任を持つ。その上に作ったシステムのデータ管理はユーザーが責任を持つ。お互いの守備範囲を明確にしたら、「怖い」と言っていた企業が動き出した。
...
**宮本さん**「…少し、黙って聞いていました。これは提案書の『未解決の問い』ではなく、このビジネス全体の存在理由です」
...
ただ、この時点での「私は何もしていない」には注釈がいる。真田さんはあくまで同じ会話の中で順番にキャラクターを演じていたに過ぎない。本当の意味でPMが自律的に動けるようになるのは、もう少し先の話だ。

上がってきたレビューが、これがまた辛辣だった。

**黒川さん（QA）**「定量効果（40〜80時間削減）の根拠がゼロ。HIGH判定の課題です」

**白石さん（デザイナー）**「シミュレーターと伴走が同一の提案書に混在して、顧客が自己同一化しにくい構造です。見せ方を分けるべきでは」
