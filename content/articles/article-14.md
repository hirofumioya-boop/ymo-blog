...
「AIに仕事をさせてみた」という話は、このシリーズでも何度か書いてきた。でも今日は少し違う。AIチームと一緒に、**プロダクトを完成させて世界に出した**——それが今日起きたことだ。（少し大げさではあるが笑）

公開した直後、ブログを読んでくれた知人からフィードバックが届いた。そのフィードバックの中に「共有できる実例があれば嬉しい、公開できる範囲で」という一言があった。
