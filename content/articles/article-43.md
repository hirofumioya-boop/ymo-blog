...
number: 43
slug: "article-43"
title: "AIをより安全に活用するために、「分ける・残す・防ぐ」に気づいた話。"
date: "2026-04-18"
tags: ["セキュリティ"]
summary-type: "整理型"
...
<p>AIを安全に活用するための3原則を整理した。「分ける・残す・防ぐ」に集約された話。</p>
<p>AIが操作しているのではない。操作しているのはあなたで、AIはあなたの権限で動いている——この認識が分岐点。
分ける（最小権限）・残す（ログで追える）・防ぐ（怪しいツールを入れない）の3原則に整理した。
セキュリティは怖がるためにあるのではない。ガードレールがあるからこそ、アクセルを踏める。</p>
</aside>
...
[No.26](/articles/article-26)でセキュリティ対策を整備してから、我が社では[MCPサーバー](/glossary#mcp)と呼ばれるツールを複数導入している。
...
ClaudeやClaude Codeで使えるツールには、悪意あるものが日常的に紛れ込んでいる。「人気そうに見えるパッケージ」に偽装されており、インストールした瞬間に端末内の[API](/glossary#api)キー類が抜かれる可能性がある。
...
セキュリティを知ることは、怖がるためではない。<strong>安心してAIを活用するための準備だ。</strong>
